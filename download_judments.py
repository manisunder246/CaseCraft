...
# Set the root download directory
download_dir = '/Users/manisunder/Desktop/DEGREES & CERTS/MTECH/AI-ML/SEM-4/Dissertation/CaseCraft/IBC Judgements/'
...
def process_all_categories():
    ...
    categories = {
        "SUPREME COURT": "https://ibbi.gov.in/en/orders/supreme-court",
        "HIGH COURTS": "https://ibbi.gov.in/en/orders/high-courts",
        "NCLAT": "https://ibbi.gov.in/en/orders/nclat",
        "NCLT": "https://ibbi.gov.in/en/orders/nclt",
        "DRTs": "https://ibbi.gov.in/en/orders/drts",
        "IBBI": "https://ibbi.gov.in/en/orders/ibbi",
        "IPA/RVO": "https://ibbi.gov.in/en/orders/ipa-rvo",
        "OTHER COURTS": "https://ibbi.gov.in/en/orders/other-courts"
    }

    # Replace this with the actual number of pages for each category if available
    pages_per_category = {
        "SUPREME COURT": 66,
        "HIGH COURTS": 42,
        "NCLAT": 100,
